...
%% Results
detected_ue_sig = zeros(numel(C_vec), N_setup, N_channel_realizatios);
detected_ue_pow = zeros(numel(C_vec), N_setup, N_channel_realizatios);

MSE_cha_est_sig = zeros(numel(C_vec), N_setup, N_channel_realizatios);
MSE_cha_est_pow = zeros(numel(C_vec), N_setup, N_channel_realizatios);
...
for ind_setup = 1:N_setup
    ...
    for ind_ch =1:N_channel_realizatios
